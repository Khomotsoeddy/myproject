...
public class SampleController implements Initializable{
	...
	public String addOnsInfo() {
		...
		if(chkExtraCheese.isSelected()) {
			info = info + "\n\t" + chkExtraCheese.getText() + "\t\t" + "R 10.00";
		}
		if(chkExtraMeat.isSelected()){
			info = info + "\n\t" + chkExtraMeat.getText() + "\t\t" + "R 15.00";
		}
		if(chkMushroom.isSelected()) {
			info = info + "\n\t" + chkMushroom.getText() + "\t\t" + "R 5.00";
		}
		if(chkBlackOlives.isSelected()) {
			info = info + "\n\t" + chkBlackOlives.getText() + "\t\t" + "R 8.00";
		}
		if(chkOnions.isSelected()) {
			info = info + "\n\t" + chkOnions.getText() + "\t\t\t" + "R 7.00";
		}
		if(chkSausage.isSelected()) {
			info = info + "\n\t" + chkSausage.getText() + "\t\t\t" + "R 5.00";
		}
		if(ckhBBQ.isSelected()) {
			info = info + "\n\t" + ckhBBQ.getText() + "\t\t\t\t" + "R 10.00";
		}
		if(chkPeriperi.isSelected()) {
			info = info + "\n\t" + chkPeriperi.getText() + "\t\t" + "R 11.00";
		}
